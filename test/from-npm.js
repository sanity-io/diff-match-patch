...
function testDiffCleanupSemanticLossless() {
  ...
  dmp.diff_cleanupSemanticLossless(diffs)
  assertEquivalent(
    [[DIFF_EQUAL, 'The '], [DIFF_INSERT, 'cow and the '], [DIFF_EQUAL, 'cat.']],
    diffs,
  )
...
function testDiffCleanupSemantic() {
  ...
  dmp.diff_cleanupSemantic(diffs)
  assertEquivalent(
    [[DIFF_EQUAL, 'The '], [DIFF_DELETE, 'cow and the '], [DIFF_EQUAL, 'cat.']],
    diffs,
  )
  ...
  dmp.diff_cleanupSemantic(diffs)
  assertEquivalent(
    [[DIFF_INSERT, 'def'], [DIFF_EQUAL, 'xxx'], [DIFF_DELETE, 'abc']],
    diffs,
  )
...
function testDiffCleanupEfficiency() {
  ...
  dmp.diff_cleanupEfficiency(diffs)
  assertEquivalent(
    [[DIFF_DELETE, 'abxyzcd'], [DIFF_INSERT, '12xy34z56']],
    diffs,
  )
  ...
  dmp.diff_cleanupEfficiency(diffs)
  assertEquivalent(
    [[DIFF_DELETE, 'abwxyzcd'], [DIFF_INSERT, '12wxyz34']],
    diffs,
  )
  dmp.Diff_EditCost = 4
}
...
function testDiffXIndex() {
  ...
  assertEquals(
    5,
    dmp.diff_xIndex(
      [[DIFF_DELETE, 'a'], [DIFF_INSERT, '1234'], [DIFF_EQUAL, 'xyz']],
      2,
    ),
  )
  ...
  assertEquals(
    1,
    dmp.diff_xIndex(
      [[DIFF_EQUAL, 'a'], [DIFF_DELETE, '1234'], [DIFF_EQUAL, 'xyz']],
      3,
    ),
  )
}
